...
class DictLoader(BaseLoader):
    ...
    >>> loader = DictLoader({'index.j2': 'source here'})
...
class PrefixLoader(BaseLoader):
    ...
    By loading ``'app1/index.j2'`` the file from the app1 package is loaded,
    by loading ``'app2/index.j2'`` the file from the second.
    """
